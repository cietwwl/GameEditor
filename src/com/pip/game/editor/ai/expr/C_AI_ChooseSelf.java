 ...
 * @author lighthu
 */
public class C_AI_ChooseSelf extends AbstractExpr {

    /**
     * 构造指定全局变量的模板。
     * @param name 全局变量名称
     */
    public C_AI_ChooseSelf() {
    }
    ...
    public IExpr recognize(QuestInfo qinfo, Expression expr) {
        if (expr.getLeftExpr().type == Expr0.TYPE_FUNC && expr.getLeftExpr().getFunctionCall().funcName.equals("AI_ChooseSelf") && expr.getRightExpr() == null) {
