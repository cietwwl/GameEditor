 ...
 * @author lighthu
 */
public class C_AI_ChooseMultiEnemy extends AbstractExpr {
    ...
    public String getExpression() {
        String left = "AI_ChooseMultiEnemy(" + minDist + "," + maxDist + "," + minHp + "," + maxHp + "," + minHpPer + "," + maxHpPer + "," + orderType + "," + chooseType + "," + startIndex + "," + maxCount + ")";
        if (checkTrue) {
            return left;
        } else {
            return left + " == false";
    ...
    public IExpr createNew(QuestInfo qinfo) {
        return new C_AI_ChooseMultiEnemy();
    }
    ...
    public IExpr recognize(QuestInfo qinfo, Expression expr) {
        if (expr.getLeftExpr().type == Expr0.TYPE_FUNC && expr.getLeftExpr().getFunctionCall().funcName.equals("AI_ChooseMultiEnemy")) {
            ...
            if (param1.getRightExpr() == null && param1.getLeftExpr().type == Expr0.TYPE_NUMBER &&
                ...
                C_AI_ChooseMultiEnemy ret = (C_AI_ChooseMultiEnemy)createNew(qinfo);
    ...
    public IPropertyDescriptor[] getPropertyDescriptors() {
        return new IPropertyDescriptor[] {
                ...
                new ComboBoxPropertyDescriptor("orderType", "排序标准", new String[] { "仇恨", "距离", "血量", "血量百分比" }),
