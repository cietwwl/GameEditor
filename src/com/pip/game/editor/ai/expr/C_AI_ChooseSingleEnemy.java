 ...
 * @author lighthu
 */
public class C_AI_ChooseSingleEnemy extends AbstractExpr {
    ...
    public String getExpression() {
        String left = "AI_ChooseSingleEnemy(" + minDist + "," + maxDist + "," + minHp + "," + maxHp + "," + minHpPer + "," + maxHpPer + "," + orderType + "," + index + ")";
        if (checkTrue) {
            return left;
        } else {
            return left + " == false";
    ...
    public IExpr createNew(QuestInfo qinfo) {
        return new C_AI_ChooseSingleEnemy();
    }
    ...
    public IExpr recognize(QuestInfo qinfo, Expression expr) {
        if (expr.getLeftExpr().type == Expr0.TYPE_FUNC && expr.getLeftExpr().getFunctionCall().funcName.equals("AI_ChooseSingleEnemy")) {
            ...
            if (param1.getRightExpr() == null && param1.getLeftExpr().type == Expr0.TYPE_NUMBER &&
                ...
                C_AI_ChooseSingleEnemy ret = (C_AI_ChooseSingleEnemy)createNew(qinfo);
