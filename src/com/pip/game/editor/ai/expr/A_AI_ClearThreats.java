 ...
 * @author lighthu
 */
public class A_AI_ClearThreats extends AbstractExpr {

    /**
     * 构造指定全局变量的模板。
     * @param name 全局变量名称
     */
    public A_AI_ClearThreats() {
    }
    ...
    public IExpr recognize(QuestInfo qinfo, Expression expr) {
        if (expr.getLeftExpr().type == Expr0.TYPE_FUNC && expr.getLeftExpr().getFunctionCall().funcName.equals("AI_ClearThreats") && expr.getRightExpr() == null) {
