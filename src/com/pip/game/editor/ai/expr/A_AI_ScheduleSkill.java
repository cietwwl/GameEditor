...
/**
 * 表达式模板，随机加一个技能到战斗技能队列中。
 * @author lighthu
 */
public class A_AI_ScheduleSkill extends AbstractExpr {
    ...
    public String getExpression() {
        ...
        return "AI_ScheduleSkill(\"" + sb.toString() + "\")";
    }
    ...
    public IExpr recognize(QuestInfo qinfo, Expression expr) {
        if (expr.getLeftExpr().type == Expr0.TYPE_FUNC && expr.getLeftExpr().getFunctionCall().funcName.equals("AI_ScheduleSkill") && expr.getRightExpr() == null) {
            ...
            if (param1.getRightExpr() == null && param1.getLeftExpr().type == Expr0.TYPE_STRING) {
                A_AI_ScheduleSkill ret = (A_AI_ScheduleSkill)createNew(qinfo);
