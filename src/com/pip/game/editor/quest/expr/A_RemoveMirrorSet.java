 ...
 * @author tzhang
 */
public class A_RemoveMirrorSet extends AbstractExpr {
    public int mapId;
	public int mask;
	...
	public String getExpression() {
		return "RemoveMirrorSet(" + mapId + "," + mask + ")";
	}
	...
	public IExpr recognize(QuestInfo qinfo, Expression expr) {
		if (expr.getLeftExpr().type == Expr0.TYPE_FUNC && expr.getLeftExpr().getFunctionCall().funcName.equals("RemoveMirrorSet") && expr.getRightExpr() == null) {
			FunctionCall fc = expr.getLeftExpr().getFunctionCall();
			
			if(fc.getParamCount() == 1){
			    Expression param1 = fc.getParam(0);
			    if (param1.getRightExpr() == null && param1.getLeftExpr().type == Expr0.TYPE_NUMBER){
			        A_RemoveMirrorSet ret = (A_RemoveMirrorSet)createNew(null);
