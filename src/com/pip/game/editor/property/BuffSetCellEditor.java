...
public class BuffSetCellEditor extends CellEditor {
    ...
    public BuffSetCellEditor(Composite parent) {
    ...
    protected Control createControl(Composite parent) {
        ...
        text.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent e) {
                BuffSetCellEditor.this.focusLost();
            }
        });
    ...
    protected void doSetValue(Object value) {
        ...
        buffIDs = (String)value;
        text.setText(BuffConfig.toString(ProjectData.getActiveProject(), buffIDs));
    }
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != BuffSetCellEditor.class;
    }
    ...
    protected void editText() {
        ChooseBuffSetDialog dlg = new ChooseBuffSetDialog(text.getShell());
        dlg.setSelectedSkill(buffIDs);
        if (dlg.open() == Dialog.OK) {
            buffIDs = dlg.getSelectedSkills();
            text.setText(BuffConfig.toString(ProjectData.getActiveProject(), buffIDs));
            fireApplyEditorValue();
            deactivate();
        }
