...
public class NPCCellEditor extends CellEditor {
    ...
    protected void doSetValue(Object value) {
        if(value instanceof Integer){
            ...
            text.setText(GameMapObject.toString(ProjectData.getActiveProject(), npcID));
        }else if(value instanceof String){
            Assert.isTrue(text != null && (value instanceof String));
            npcID = Integer.parseInt((String)value);
            text.setText(GameMapObject.toString(ProjectData.getActiveProject(), npcID)); 
        }
    }
    ...
    protected void editText() {
        ChooseNPCDialog dlg = new ChooseNPCDialog(text.getShell(), ChooseNPCDialog.ONENPC);
