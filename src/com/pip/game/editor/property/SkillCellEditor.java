...
public class SkillCellEditor extends CellEditor {
    ...
    protected void doSetValue(Object value) {
        ...
        text.setText(SkillConfig.toString(ProjectData.getActiveProject(), skillID));
    }
    ...
    protected void editText() {
        ChooseDataObjectDialog dlg = new ChooseDataObjectDialog(text.getShell(), SkillConfig.class, "选择技能");
        dlg.setSelDataObject(skillID);
        if (dlg.open() == Dialog.OK) {
            if(dlg.getSelectedDataObject() != null) {
                skillID = dlg.getSelectedDataObject().id;
            } else {
                skillID = -1;
            }
