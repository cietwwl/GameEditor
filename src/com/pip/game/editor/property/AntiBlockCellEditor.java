 ...
 * µôÂä×éÑ¡Ôñ¡£
 */
public class AntiBlockCellEditor extends CellEditor {
    protected Composite container;
    protected Text text;
    protected Button button;
    protected int[] data;

    public AntiBlockCellEditor(Composite parent) {
    ...
    protected Control createControl(Composite parent) {
        ...
        text.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent e) {
                AntiBlockCellEditor.this.focusLost();
            }
        });
    ...
    protected void doSetValue(Object value) {
        Assert.isTrue(text != null && (value == null || value instanceof int[]));
        if (value == null) {
            data = null;
        } else {
            data = ((int[])value).clone();
        }
        text.setText(getText(data));
    }
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != AntiBlockCellEditor.class;
    }
    ...
    protected void editText() {
        EditAntiBlockDialog dlg = new EditAntiBlockDialog(text.getShell());
        dlg.setData(data);
