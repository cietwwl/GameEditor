...
public class BuffCellEditor extends CellEditor {
    ...
    protected byte type;
    public BuffCellEditor(Composite parent, byte type) {
    ...
    protected void doSetValue(Object value) {
        ...
        text.setText(BuffConfig.toString(ProjectData.getActiveProject(), buffID));
    }
    ...
    protected void editText() {
        ChooseBuffDialog dlg = new ChooseBuffDialog(text.getShell(), type);
