 ...
 * µØµã±à¼­Æ÷¡£
 */
public abstract class CellEditorAdapter extends CellEditor {
    protected Composite container;
    protected Text text;
    protected Button button;

            
    public CellEditorAdapter(Composite parent) {
    ...
    protected Control createControl(Composite parent) {
        ...
        text.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent e) {
                CellEditorAdapter.this.focusLost();
            }
        });
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != CellEditorAdapter.class;
    }
    ...
    abstract protected void editText();
}
