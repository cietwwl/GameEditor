 ...
 * ¹ÖÎï×é±à¼­Æ÷¡£
 */
public class MonsterGroupCellEditor extends CellEditor {
    protected Composite container;
    protected Text text;
    protected Button button;
    protected int templateID;

    public MonsterGroupCellEditor(Composite parent) {
    ...
    protected Control createControl(Composite parent) {
        ...
        text.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent e) {
                MonsterGroupCellEditor.this.focusLost();
            }
        });
    ...
    protected void doSetValue(Object value) {
        ...
        text.setText(MonsterGroup.toString(ProjectData.getActiveProject(), templateID));
    }
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != MonsterGroupCellEditor.class;
    }
    ...
    protected void editText() {
        ChooseMonsterGroupDialog dlg = new ChooseMonsterGroupDialog(text.getShell());
