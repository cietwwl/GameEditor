 ...
 * @author Joyce
 */
public class ItemSetCellEditor extends CellEditor {

    protected Composite container;
    protected Text text;
    protected Button button;
    protected List<ItemDefData> items = new ArrayList<ItemDefData>();

    protected boolean needEditNum;

    public ItemSetCellEditor(Composite parent) {
        super(parent, SWT.NONE);
        this.needEditNum = false;
    }

    public ItemSetCellEditor(Composite parent, boolean needEditNum) {
        super(parent, SWT.NONE);
    ...
    protected Control createControl(Composite parent) {
        ...
        text.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent e) {
                ItemSetCellEditor.this.focusLost();
            }
        });
    ...
    protected Object doGetValue() {
        String value = ItemDefData.formatToString(items);
    ...
    protected void doSetValue(Object value) {
        ...
        items = ItemDefData.parseFromString((String) value);
        text.setText(ItemDefData.getDescString(items, needEditNum));
    }
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != ItemSetCellEditor.class;
    }
    ...
    protected void editText() {
        ChooseMultiItemDialog dlg = new ChooseMultiItemDialog(text.getShell());
        dlg.setMultiSel(true);
        dlg.setNeedEditNum(needEditNum);
        dlg.setSelectedItems(items);
