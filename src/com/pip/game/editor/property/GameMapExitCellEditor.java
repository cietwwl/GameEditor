 ...
 * exit±à¼­Æ÷¡£
 */
public class GameMapExitCellEditor extends CellEditor {
    ...
    public GameMapExitCellEditor(Composite parent,GameMapInfo gameMapInfo,MultiTargetMapExit mapExit) {
    ...
    protected Control createControl(Composite parent) {
        ...
        text.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent e) {
                GameMapExitCellEditor.this.focusLost();
            }
        });
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != GameMapExitCellEditor.class;
    }
    ...
    protected void editText() {
        MultiTargetMapExitDialog dlg = new MultiTargetMapExitDialog(text.getShell(),gameMapInfo,mapExit);
