...
public class MirrorSetCellEditor extends CellEditor {
    protected Composite container;
    protected Text text;
    protected Button button;
    protected long mirrorSet;
    protected GameMapInfo mapInfo;

    public MirrorSetCellEditor(Composite parent, GameMapInfo mapInfo) {
    ...
    protected Control createControl(Composite parent) {
        ...
        text.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent e) {
                MirrorSetCellEditor.this.focusLost();
            }
        });
    ...
    protected void doSetValue(Object value) {
        Assert.isTrue(text != null && (value instanceof Long));
        mirrorSet = ((Long)value).longValue();
        text.setText(getMirrorSetText(mapInfo, mirrorSet));
    }
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != MirrorSetCellEditor.class;
    }
    ...
    protected void editText() {
        ChooseMirrorDialog dlg = new ChooseMirrorDialog(text.getShell(), mapInfo.mirrorNames, mirrorSet);
        if (dlg.open() == Dialog.OK) {
            mirrorSet = dlg.getMirrorSet();
            text.setText(getMirrorSetText(mapInfo, mirrorSet));
            fireApplyEditorValue();
            deactivate();
        }
    ...
    public static String getMirrorSetText(GameMapInfo mapInfo, long mirrorSet) {
        ...
        for (int i = 0; i < 64; i++) {
            ...
            if ((mirrorSet & mask) != 0) {
                ...
                sb.append(mapInfo.mirrorNames[i]);
            }
        }
        return sb.toString();
    }
