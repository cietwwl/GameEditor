 ...
 * 公式限制编辑器。
 */
public class ConstraintsCellEditor extends CellEditor {
    protected Composite container;
    protected Text text;
    protected Button button;
    protected String constraints;

    public ConstraintsCellEditor(Composite parent) {
    ...
    protected Control createControl(Composite parent) {
        ...
        text.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent e) {
                ConstraintsCellEditor.this.focusLost();
            }
        });
    ...
    protected void doSetValue(Object value) {
        ...
        text.setText(ExpressionList.toNatureString(constraints));
    }
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != ConstraintsCellEditor.class;
    }
    ...
    protected void editText() {
        String newExpr = ExpressionDialog.open(text.getShell(), constraints, 
