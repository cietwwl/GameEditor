 ...
 * ²ÎÊýÐÞ¸ÄÆ÷±à¼­¡£
 */
public class ConditionsCellEditor extends CellEditor {
    protected Composite container;
    protected Text text;
    protected Button button;
    protected MultiConditions editObj = new MultiConditions();

    public ConditionsCellEditor(Composite parent) {
    ...
    protected Control createControl(Composite parent) {
        ...
        text.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent e) {
                ConditionsCellEditor.this.focusLost();
            }
        });
    ...
    protected void doSetValue(Object value) {
        ...
        editObj.conditionText = (String) value;
        text.setText(ExpressionList.toNatureString(editObj.conditionText));
    }
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != ConditionsCellEditor.class;
    }
    ...
    private void onEditCondition() {
        String newExpr = ExpressionDialog.open(text.getShell(), editObj.conditionText, 
                new QuestInfo(new Quest(ProjectData.getActiveProject())), TemplateManager.CONTEXT_SET_CONDITION);
        //String newExpr = ItemExpressionDlg.open(getShell(), additionalCondition, itemInfo);
        if (newExpr != null) {
            editObj.conditionText = newExpr;
            text.setText(ExpressionList.toNatureString(newExpr));
            editObj.natrualText = text.getText();
        }
        fireApplyEditorValue();
        deactivate();
    }
...
//            text.setText(editObj.toString(ProjectData.getActiveProject()));
//            fireApplyEditorValue();
//            deactivate();
//        
//    }
