...
public class VehicleTemplateCellEditor extends CellEditor {
    ...
    public VehicleTemplateCellEditor(Composite parent) {
    ...
    protected Control createControl(Composite parent) {
        ...
        text.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent e) {
                VehicleTemplateCellEditor.this.focusLost();
            }
        });
        text.addMouseListener(new MouseAdapter() {
            public void mouseDoubleClick(MouseEvent e) {
                if (e.button == 1) {
                    Vehicle template = (Vehicle)ProjectData.getActiveProject().findObject(Vehicle.class, templateID);
                    if (template != null) {
    ...
    protected void doSetValue(Object value) {
        if(value instanceof Integer){
            ...
            text.setText(Vehicle.toString(ProjectData.getActiveProject(), templateID));
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != VehicleTemplateCellEditor.class;
    }
    ...
    protected void editText() {
        ChooseVehicleTemplateDialog dlg = new ChooseVehicleTemplateDialog(text.getShell(), ChooseVehicleTemplateDialog.ONE_TYPE);
