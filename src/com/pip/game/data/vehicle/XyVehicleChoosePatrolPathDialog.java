...
public class XyVehicleChoosePatrolPathDialog extends Dialog {
...
private HashMap<GameArea, MapFile> mapCache = new HashMap<GameArea, MapFile>();
    ...
    public void setPatrolPathId(int sel, XyGameMapVehicle mapNPC) {
     ...
     * @param parentShell
     */
    public XyVehicleChoosePatrolPathDialog(Shell parentShell) {
        super(parentShell);
    }
