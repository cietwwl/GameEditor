 ...
 * @author jhkang
 */
public class Effect_IMMUNE_MAGIC_ATTACK extends Effect_PercentAdd{

    public Effect_IMMUNE_MAGIC_ATTACK(int t) {
        super(t);
    }
    ...
    public void genBuffPostHit(PrintWriter out, String p1, String p2){
        ...
        out.println("        if (!isActive && context.hited() && context.type instanceof MagicSkill) {");
